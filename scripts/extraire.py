...
Usage :
    ...
    .venv\Scripts\python.exe scripts\extraire.py --rome D1302    # un seul code, pour essayer
...
# Choisis pour le métier de responsable retail (codes ROME 4.0, MétierScope France Travail) ;
# la page permet de cocher/décocher.
METIERS = {
    # Cœur retail : diriger un point de vente
    "D1302": ("Responsable de boutique / de magasin", "Magasin", True),
    "D1504": ("Directeur(trice) de magasin de grande distribution", "Magasin", True),
    "D1301": ("Gérant(e) de magasin d'alimentation générale", "Magasin", True),
    "D1305": ("Responsable de magasin cycles", "Magasin", True),
    "D1512": ("Directeur(trice) régional(e) d'hyper ou de supermarché", "Magasin", True),
    # Encadrer un rayon, un secteur, un département
    "D1509": ("Responsable de département en grande distribution", "Rayon", True),
    "D1510": ("Chef(fe) de secteur magasin", "Rayon", True),
    "D1517": ("Chef(fe) de secteur distribution", "Rayon", True),
    "D1503": ("Chef(fe) de rayon produits non alimentaires", "Rayon", True),
    "D1502": ("Chef(fe) de rayon produits alimentaires", "Rayon", True),
    "D1513": ("Chef(fe) de rayon produits frais", "Rayon", True),
    "D1508": ("Responsable de caisses", "Rayon", True),
    # Marketing du point de vente, commerce et réseau, à la frontière
    "D1516": ("Responsable merchandising", "Frontière", False),
    "D1506": ("Chargé(e) de merchandising", "Frontière", False),
    "M1720": ("Category manager", "Frontière", False),
    "E1113": ("Responsable e-commerce", "Frontière", False),
    "D1417": ("Chef(fe) des ventes", "Frontière", False),
    "K1816": ("Manager de commerce et territoire", "Frontière", False),
}
